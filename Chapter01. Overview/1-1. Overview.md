...
PhysicAI Arm 개발은 local 환경과 remote PC 환경 두 가지로 진행할 수 있습니다. Remote PC를 통한 개발을 하고 싶을 경우 [아래 Remote PC 환경 시작하기](/Chapter01.%20Overview/1-1.%20Overview.md#Remote-PC-환경-시작하기)부분을 읽으시면 됩니다. 바로 밑은 local 환경 개발에 대한 설명을 진행하겠습니다.
...
바로가기를 연 후, Display number를 0으로 바꾸고 다음으로 넘어갑니다.
