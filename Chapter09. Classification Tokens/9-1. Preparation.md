...
class LoggerNode(Node):
    def __init__(self):
        ...
        self.declare_parameter("save_dir", "dataset_raw_classification")
        self.declare_parameter("episode_id", 0)
        self.declare_parameter("task_name", "classify")
...
RAW_ROOT = Path("./dataset_raw_classification")
OUT_REPO_ID = "local/classify_tokens_dataset"
...
class ClassificationInferenceNode(Node):
    def __init__(self):
        ...
        self.declare_parameter("policy_path", "/home/soda/physicai_arm_ws/outputs/train/classify_tokens/checkpoints/last/pretrained_model")
        ...
        stats = load_or_compute_stats("local/classify_tokens_dataset", STATS_CACHE_PATH)
