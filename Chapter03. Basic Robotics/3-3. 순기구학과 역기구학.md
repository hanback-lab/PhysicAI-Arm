...
<img src="pds/FK&IK.png" style="width:60%;">
...
```
```math
\theta_{1} = \mathrm{atan2}(y,x) - \mathrm{atan2}(l_{2}\sin\theta_{2},l_{1} + l_{2}\cos\theta_{2})
```
...
<img src="pds/IK_simulator.png" style="width:50%;">
----
